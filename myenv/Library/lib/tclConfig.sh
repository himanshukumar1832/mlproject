...
# installed.
TCL_PREFIX='C:/Himanshu Programing/mlproject/myenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Himanshu Programing/mlproject/myenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Himanshu Programing/mlproject/myenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Himanshu Programing/mlproject/myenv\Library\include'
...
TCL_PACKAGE_PATH='C:/Himanshu Programing/mlproject/myenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Himanshu Programing/mlproject/myenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Himanshu Programing/mlproject/myenv\Library\lib\tclstub86.lib'
